...
const PROTO_PATH =
  __dirname + (process.env.PROTO_PATH || "/audio_to_text.proto");
...
function startServer() {
  ...
  app.post("/batch-service", function (req, res) {
    ...
    getSrtResponse(grpc_client, msg)
      .then((response) => {
  ...
  app.post("/api/feedback", function (req, res) {
    const file = req.file;
    const { user_id, language, text, rating, feedback, device, browser, date } =
      req.body;
